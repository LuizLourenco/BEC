...
- [ ] Modelagem de dados detalhada (acervo, leitores, empréstimos) — ver [`docs/DATA_MODEL.md`](DATA_MODEL.md) quando criado; gatilho: antes de iniciar a implementação do módulo de empréstimos.
