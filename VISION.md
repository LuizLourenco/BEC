...
O **BEC** existe para oferecer uma alternativa **leve, gratuita, simples de operar e simples de hospedar**, feita sob medida para essa realidade.

## Escopo

### O que o BEC É

- Um sistema web (PWA) para **catalogação de acervo** (livros e, futuramente, outros materiais espíritas).
